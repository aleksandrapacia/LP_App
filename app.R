...
ochrona_przyrody <- read_csv("C://Users//User//OneDrive//Pulpit//LP_App//voivodeships_data.csv", locale = locale(encoding = "UTF-8"))
...
data <- tibble(
  ...
  longitude = runif(100, 14.0, 24.09),  # Zakres długości geograficznej Polski
